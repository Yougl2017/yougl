...
public class dhd extends JFrame implements KeyShortcut {
	...
	public dhd() {
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(panel_kh_info, GroupLayout.DEFAULT_SIZE, 854, Short.MAX_VALUE)
						.addComponent(panel_title, GroupLayout.DEFAULT_SIZE, 854, Short.MAX_VALUE))
					.addGap(20))
		...
		//磨边单价
		textField_mbprice = new JTextField("0.00");
						...
						.addGroup(gl_panel_pro.createSequentialGroup()
							.addGroup(gl_panel_pro.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_pro.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(text_other, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
								...
								.addGroup(gl_panel_pro.createSequentialGroup()
									...
									.addGroup(gl_panel_pro.createParallelGroup(Alignment.LEADING, false)
										.addGroup(gl_panel_pro.createSequentialGroup()
											...
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(textField_zkcount, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_panel_pro.createSequentialGroup()
											.addComponent(lblNewLabel)
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(textField_kkcount)))
									.addPreferredGap(ComponentPlacement.RELATED)
									.addGroup(gl_panel_pro.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(gl_panel_pro.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_pro.createSequentialGroup()
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(textField_count, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE)))
	...
	//文本框-文本框 快捷键enter
	public  void textf_key(JTextField f,JTextField t){
			...
			public void keyPressed(KeyEvent e) {
				...
				if(e.getSource()==f){
					if(e.getKeyCode()==KeyEvent.VK_ENTER){
						t.requestFocus();
						t.selectAll();  //全选内容
						if (e.getSource()==textField_long || e.getSource()==textField_wide||e.getSource()==textField_price ){
	...
	public void getSquare(){
		...
		{
			double sum=0.25*Double.valueOf(textField_count.getText());
	        label_mj.setForeground(Color.red);
			label_mj.setText(""+sum+"");
			label_square.setText("㎡");
			label_square.setForeground(Color.red);
	...
	public void getmoney(){
		double sum = Double.valueOf(label_mj.getText())*Double.valueOf(textField_price.getText());
	...
	public double GetPerimeterFuntion(){
		...
		if(RadioButton_sb.isSelected()){
			l=(Integer.parseInt(textField_long.getText())+Integer.parseInt(textField_wide.getText()))*2*0.001
					*Integer.parseInt(textField_count.getText());
			textField_perimeter.setEditable(false);
	...
	public void deleTable(){
		...
		Object str = table.getModel().getValueAt(row, 13);
		String sql="delete from temp_sale_detail where mxxh='"+str+"'";
    ...
    public void InsertGoods(){
    	...
    	double zje  = Double.valueOf(label_sum.getText())+kkdj*kksl+zkdj*zksl+mbdj*mbzc*sl;
